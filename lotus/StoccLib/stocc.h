...
*
* Modified by P. Frazier on 2010-03-10 for ORIE 5582
*
* Description:
...
* Calculates the inverse of the normal cdf.
*
* double Erf (double x);
* Calculates the error function, which is related to the integral of the normal distribution.
*
...
double ErfC (double x);                 // complementary error function (wnchyppr.cpp)
double NormCdf(double x);               // normal cdf (wnchyppr.cpp)
double InvNormCdf(double x);            // inverse of normal cdf (wnchyppr.cpp)
double InvErfC (double x);              // inverse of ErfC (wnchyppr.cpp)
